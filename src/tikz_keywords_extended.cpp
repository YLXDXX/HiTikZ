...
void registerExtended(Vec &db)
{
    ...
    const char *ctikzNodeShapes[] = {
        ...
        "circulator", "clockwedge", "coupler", "coupler2", "diamondpole", "dinantenna", "dipchip",
        ...
        "flipflop", "fourport",         "genericsplitter", "gm amp", "ground", "gyrator", "harmonics",
        ...
        "tgate", "tground", "tlground", "tlinestub", "transformer", "transformer core",
        "txantenna", "vcc",
