...
void registerCommands(Vec &db)
{
    ...
    const char *tkeCmds[] = {
        ...
        // ── v5.10c commands added after full source cross-check ──
        "tkzAddName","tkzCSym","tkzDefCentroidTriangle","tkzDefCheopsTriangle",
        "tkzDefCircleHomothety","tkzDefCircleReflection","tkzDefCircleRotation","tkzDefCircleSymmetry",
        "tkzDefCircleTranslation","tkzDefDivHarmonicBoth","tkzDefDivHarmonicExt","tkzDefDivHarmonicInt",
        "tkzDefEulerRadius","tkzDefExRadius","tkzDefExtSimilitudeCenter","tkzDefFeuerbachTriangle",
        "tkzDefGoldenRatio","tkzDefGoldTriangle","tkzDefIntSimilitudeCenter","tkzDefInversionNegativeCircle",
        "tkzDefIsoscelesRightTriangle","tkzDefOrthoThroughCircle","tkzDefSchoolTriangle","tkzDefSimilitudeCenter",
        "tkzDefSpcTriangle","tkzDefSymmedialTriangle","tkzDefTwoOne","tkzDet",
        "tkzDivHarmonic","tkzDotProduct","tkzDrawArcRAN","tkzDrawArcRAngles",
        "tkzDrawArcRotate","tkzDrawArcRwithNodes","tkzDrawArcTowards","tkzDrawSectorN",
        "tkzDrawSectorRAngles","tkzDrawSectorRotate","tkzDrawSemiCircles","tkzFeuerbachCenter",
        "tkzFillSectorAngles","tkzFillSectorN","tkzFillSectorR","tkzFillSectorRAngles",
        "tkzFillSectorRotate","tkzGergonneCenter","tkzGetResult","tkzGetVectxy",
        "tkzHomo","tkzInterCCWithNodes","tkzInterLCWithNodes","tkzInterLLxy",
        "tkzIsLinear","tkzIsOrtho","tkzMittenpunktCenter","tkzNagelCenter",
        "tkzNormalizeAngle","tkzOrthogonalCenter","tkzPathArcRAN","tkzPermute",
        "tkzPointShowCoord","tkzPowerCircle","tkzRandPointOnCircle","tkzRandPointOnCircleThrough",
        "tkzRandPointOnDisk","tkzRandPointOnLine","tkzRandPointOnRect","tkzRandPointOnSegment",
        "tkzRegPolygonSide","tkzRotateInRad","tkzRotateWithNodes","tkzSetUpAllColors",
        "tkzShowBisectorLine","tkzShowCSym","tkzShowOrthLine","tkzShowSymOrth",
        "tkzShowTranslation","tkzSpiekerCenter","tkzSymmedianCenter","tkzSymOrth",
        "tkzTestInterCC","tkzTestInterLC","tkzTgtAt","tkzTgtFromP",
        "tkzTgtFromPR","tkzUCSym","tkzUHomo","tkzUInverseNegativePoint",
        "tkzUInversePoint","tkzUProjection","tkzURotateInRad","tkzURotateWithNodes",
        "tkzUSymOrth","tkzUTranslation","tkzVecK","tkzVecKNorm",
        "tkzVecKOrth","tkzVecKOrthNorm",
        nullptr
    };
    ...
    const char *cmds[] = {
        ...
        "fi","fill","filldraw","flat","foreach",
        "gdef","global","graph",
        "hbox","hfil","hfill","hline","hrule","hskip","hspace",
        "if","ifcase","ifdim","iffalse","ifhmode","ifinner","ifmmode","ifnum","ifodd","iftrue","ifvmode","ifx",
        "input","item",
        "label","let","line","ln",
