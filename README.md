...
├── tikz_keywords_extended.cpp       # CircuiTikZ 形状/选项、tikz-cd、graphs、pgfplots 扩展等（已清理空间伪命令/大小写错误/重复项）
│                                    #（合计 ~1400+ 条目：CircuiTikZ 路径元件 394 + CircuiTikZ node 形状 128 + 形状~120 + PGF键路径30+ + tkz-euclide v5 72 命令）
