...
├── tikz_keywords_commands.cpp       # 命令 + CircuiTikZ 路径元件（394 个，源自 CircuiTikZ 1.7.1）+ tkz-euclide + 数学函数
...
├── test_document_state.cpp          # 文档状态追踪（15 个用例：范围/库/样式/坐标/pic/foreach(含可选参数)/颜色）
